...
type UserApiClient interface {
	...
	GetById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetByResponse, error)
	GetByName(ctx context.Context, in *GetByNameRequest, opts ...grpc.CallOption) (*GetByResponse, error)
...
func (c *userApiClient) GetById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetByResponse, error) {
	out := new(GetByResponse)
	err := c.cc.Invoke(ctx, "/api.user_v1.UserApi/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userApiClient) GetByName(ctx context.Context, in *GetByNameRequest, opts ...grpc.CallOption) (*GetByResponse, error) {
	out := new(GetByResponse)
	err := c.cc.Invoke(ctx, "/api.user_v1.UserApi/GetByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserApiServer interface {
	...
	GetById(context.Context, *GetByIdRequest) (*GetByResponse, error)
	GetByName(context.Context, *GetByNameRequest) (*GetByResponse, error)
...
func (UnimplementedUserApiServer) GetById(context.Context, *GetByIdRequest) (*GetByResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetById not implemented")
}
func (UnimplementedUserApiServer) GetByName(context.Context, *GetByNameRequest) (*GetByResponse, error) {
...
func _UserApi_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user_v1.UserApi/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserApi_GetByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserApiServer).GetByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user_v1.UserApi/GetByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserApiServer).GetByName(ctx, req.(*GetByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserApi_GetByName_Handler,
		},
		{
			MethodName: "Update",
