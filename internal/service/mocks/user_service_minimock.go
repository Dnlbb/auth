...
//go:generate minimock -i github.com/Dnlbb/auth/internal/service/servinterfaces.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
// UserServiceMock implements mm_servinterfaces.UserService
...
// NewUserServiceMock returns a mock for mm_servinterfaces.UserService
...
func (mmCreate *mUserServiceMockCreate) Return(ip1 *int64, err error) *UserServiceMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &UserServiceMockCreateResults{ip1, err}
	mmCreate.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmCreate.mock
}

// Set uses given function f to mock the UserService.Create method
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user models.User) (ip1 *int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
func (e *UserServiceMockCreateExpectation) Then(ip1 *int64, err error) *UserServiceMock {
	e.results = &UserServiceMockCreateResults{ip1, err}
	return e.mock
}
...
// Create implements mm_servinterfaces.UserService
func (mmCreate *UserServiceMock) Create(ctx context.Context, user models.User) (ip1 *int64, err error) {
...
func (mmDelete *mUserServiceMockDelete) Expect(ctx context.Context, userID models.DeleteID) *mUserServiceMockDelete {
...
func (mmDelete *mUserServiceMockDelete) ExpectUserIDParam2(userID models.DeleteID) *mUserServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mUserServiceMockDelete) Inspect(f func(ctx context.Context, userID models.DeleteID)) *mUserServiceMockDelete {
...
func (mmDelete *mUserServiceMockDelete) Set(f func(ctx context.Context, userID models.DeleteID) (err error)) *UserServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mUserServiceMockDelete) When(ctx context.Context, userID models.DeleteID) *UserServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("UserServiceMock.Delete mock is already set by Set")
	}
...
// Delete implements mm_servinterfaces.UserService
func (mmDelete *UserServiceMock) Delete(ctx context.Context, userID models.DeleteID) (err error) {
...
func (mmGet *mUserServiceMockGet) Expect(ctx context.Context, params models.GetUserParams) *mUserServiceMockGet {
	...
	mmGet.defaultExpectation.params = &UserServiceMockGetParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for UserService.Get
func (mmGet *mUserServiceMockGet) ExpectParamsParam2(params models.GetUserParams) *mUserServiceMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Inspect(f func(ctx context.Context, params models.GetUserParams)) *mUserServiceMockGet {
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, params models.GetUserParams) (up1 *models.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mUserServiceMockGet) When(ctx context.Context, params models.GetUserParams) *UserServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
	...
	expectation := &UserServiceMockGetExpectation{
		mock:               mmGet.mock,
		params:             &UserServiceMockGetParams{ctx, params},
...
// Get implements mm_servinterfaces.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, params models.GetUserParams) (up1 *models.User, err error) {
	...
	mm_params := UserServiceMockGetParams{ctx, params}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockGetParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmGet.t.Errorf("UserServiceMock.Get got unexpected parameter params, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGet.t.Fatalf("Unexpected call to UserServiceMock.Get. %v %v", ctx, params)
	return
}
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, userUpdate models.User) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectUserUpdateParam2(userUpdate models.User) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, userUpdate models.User)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, userUpdate models.User) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, userUpdate models.User) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
// Update implements mm_servinterfaces.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, userUpdate models.User) (err error) {
