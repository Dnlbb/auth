...
// AuthServiceMock implements mm_servinterfaces.AuthService
type AuthServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreate          func(ctx context.Context, user models.User) (ip1 *int64, err error)
	...
	funcDelete          func(ctx context.Context, userID models.DeleteID) (err error)
	funcDeleteOrigin    string
	inspectFuncDelete   func(ctx context.Context, userID models.DeleteID)
	...
	funcUpdate          func(ctx context.Context, userUpdate models.User) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, userUpdate models.User)
	afterUpdateCounter  uint64
	beforeUpdateCounter uint64
	UpdateMock          mAuthServiceMockUpdate
}

// NewAuthServiceMock returns a mock for mm_servinterfaces.AuthService
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, user models.User) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) ExpectUserParam2(user models.User) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, user models.User)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Return(ip1 *int64, err error) *AuthServiceMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &AuthServiceMockCreateResults{ip1, err}
	mmCreate.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmCreate.mock
}

// Set uses given function f to mock the AuthService.Create method
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, user models.User) (ip1 *int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, user models.User) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (e *AuthServiceMockCreateExpectation) Then(ip1 *int64, err error) *AuthServiceMock {
	e.results = &AuthServiceMockCreateResults{ip1, err}
	return e.mock
}
...
// Create implements mm_servinterfaces.AuthService
func (mmCreate *AuthServiceMock) Create(ctx context.Context, user models.User) (ip1 *int64, err error) {
...
func (mmDelete *mAuthServiceMockDelete) Expect(ctx context.Context, userID models.DeleteID) *mAuthServiceMockDelete {
...
// ExpectUserIDParam2 sets up expected param userID for AuthService.Delete
func (mmDelete *mAuthServiceMockDelete) ExpectUserIDParam2(userID models.DeleteID) *mAuthServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("AuthServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mAuthServiceMockDelete) Inspect(f func(ctx context.Context, userID models.DeleteID)) *mAuthServiceMockDelete {
...
func (mmDelete *mAuthServiceMockDelete) Set(f func(ctx context.Context, userID models.DeleteID) (err error)) *AuthServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mAuthServiceMockDelete) When(ctx context.Context, userID models.DeleteID) *AuthServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("AuthServiceMock.Delete mock is already set by Set")
	}
...
// Delete implements mm_servinterfaces.AuthService
func (mmDelete *AuthServiceMock) Delete(ctx context.Context, userID models.DeleteID) (err error) {
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmDelete.t.Errorf("AuthServiceMock.Delete got unexpected parameter userID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmGet *mAuthServiceMockGet) Expect(ctx context.Context, params models.GetUserParams) *mAuthServiceMockGet {
	...
	mmGet.defaultExpectation.params = &AuthServiceMockGetParams{ctx, params}
...
// ExpectParamsParam2 sets up expected param params for AuthService.Get
func (mmGet *mAuthServiceMockGet) ExpectParamsParam2(params models.GetUserParams) *mAuthServiceMockGet {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mAuthServiceMockGet) Inspect(f func(ctx context.Context, params models.GetUserParams)) *mAuthServiceMockGet {
...
func (mmGet *mAuthServiceMockGet) Return(up1 *models.User, err error) *AuthServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mAuthServiceMockGet) Set(f func(ctx context.Context, params models.GetUserParams) (up1 *models.User, err error)) *AuthServiceMock {
	if mmGet.defaultExpectation != nil {
...
// Then helper
func (mmGet *mAuthServiceMockGet) When(ctx context.Context, params models.GetUserParams) *AuthServiceMockGetExpectation {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("AuthServiceMock.Get mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockGetExpectation{
		mock:               mmGet.mock,
		params:             &AuthServiceMockGetParams{ctx, params},
...
func (e *AuthServiceMockGetExpectation) Then(up1 *models.User, err error) *AuthServiceMock {
...
// Get implements mm_servinterfaces.AuthService
func (mmGet *AuthServiceMock) Get(ctx context.Context, params models.GetUserParams) (up1 *models.User, err error) {
	...
	mm_params := AuthServiceMockGetParams{ctx, params}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockGetParams{ctx, params}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.params != nil && !minimock.Equal(*mm_want_ptrs.params, mm_got.params) {
				mmGet.t.Errorf("AuthServiceMock.Get got unexpected parameter params, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmGet.t.Fatalf("Unexpected call to AuthServiceMock.Get. %v %v", ctx, params)
	return
}
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, userUpdate models.User) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, userUpdate}
...
// ExpectUserUpdateParam2 sets up expected param userUpdate for AuthService.Update
func (mmUpdate *mAuthServiceMockUpdate) ExpectUserUpdateParam2(userUpdate models.User) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, userUpdate models.User)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, userUpdate models.User) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, userUpdate models.User) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthServiceMockUpdateParams{ctx, userUpdate},
...
// Update implements mm_servinterfaces.AuthService
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, userUpdate models.User) (err error) {
	...
	mm_params := AuthServiceMockUpdateParams{ctx, userUpdate}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, userUpdate}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userUpdate != nil && !minimock.Equal(*mm_want_ptrs.userUpdate, mm_got.userUpdate) {
				mmUpdate.t.Errorf("AuthServiceMock.Update got unexpected parameter userUpdate, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, userUpdate)
	return
}
